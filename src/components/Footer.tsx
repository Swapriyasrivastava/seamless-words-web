...
const Footer = () => {
  ...
  return (
    <footer className="py-20 px-8 border-t border-teal-600/30">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center space-x-2 text-sm mb-16">
        ...
        <div className="text-center pt-8 border-t border-teal-600/30">
